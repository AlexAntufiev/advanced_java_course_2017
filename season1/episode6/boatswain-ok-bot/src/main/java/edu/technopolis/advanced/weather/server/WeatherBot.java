...
import edu.technopolis.advanced.weather.request.*;
...
import edu.technopolis.advanced.weather.response.Subscription;
...
public class WeatherBot {
    ...
    public static void main(String[] args) {
        ...
        try {
            props.load(WeatherBot.class.getResourceAsStream("/application.properties"));
        } catch (IOException e) {
            ...
            SendMessageRequest req = new SendMessageRequest(sendEndpoint, notif.getRecipient().getChatId())
                    .setPayload(
                            new SendMessagePayload(
                                    ...
                                    new Message(weatherFactory.getWeather(notif.getMessage().getText()))
                            )
                    );
            try {
